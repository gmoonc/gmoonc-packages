...
test.describe('Criação de Categoria de Notificação - Mensagens', () => {
  test('deve criar uma categoria de notificação para mensagens', async ({ page }) => {
    console.log('🎯 Testando criação de categoria de notificação para mensagens');
    ...
    console.log('📝 Passo 4: Preenchendo formulário de categoria...');
    ...
    console.log('🎯 Teste de criação de categoria concluído com sucesso');
  });
});
